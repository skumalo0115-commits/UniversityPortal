...
<%
    ...
    /* ===== STUDENT COURSES ===== */
    List<Course> studentCourses = (List<Course>) request.getAttribute("studentCourses");
...
<header class="page-header">
    ...
    <div class="header-actions">
        ...
        <% if (loggedIn) { %>
            <a class="btn ghost logged-in-only" href="${pageContext.request.contextPath}/logout">Logout</a>
        <% } %>
...
<main class="container">
    ...
    <section class="glass-card spaced-card">
        <form class="form" action="${pageContext.request.contextPath}/student" method="post">
    ...
    <section class="glass-card spaced-card">
        ...
        <div class="details">
            ...
            <div>
                ...
                <p><%= student.getEmail() == null ? "" : student.getEmail() %></p>
            </div>
        </div>
    </section>
    ...
    <section class="glass-card spaced-card">
        ...
        <p class="muted">These modules were recently updated by lecturers.</p>
